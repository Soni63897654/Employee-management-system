        ...
        <div class="col-12">
            ...
            <div class="profile-card">
                ...
                <div class="profile-header d-flex align-items-center justify-content-between">
                    <div>
                        <h3 class="mb-1 fw-bold">{{ $employee->full_name ?? 'N/A' }}</h3>
                        <span class="emp-code">
                ...
                <div class="details-container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 info-box">
                            <div class="info-label">
                                <i class="fa-solid fa-briefcase"></i> Department
                            </div>
                        ...
                        <div class="col-md-3 info-box">
                            <div class="info-label">
                                <i class="fa-solid fa-user-tie"></i> Reporting Manager
                            </div>
                            <div class="info-value">
                        ...
                        <div class="col-md-3 info-box">
                            <div class="info-label">
                                <i class="fa-solid fa-calendar"></i> Joining Date
                            </div>
                            <div class="info-value">
                    ...
                    <div class="row">
                        <div class="col-12 info-box">
                            <div class="info-label">
                                <i class="fa-solid fa-location-dot"></i> Residential Address
                            </div>
                ...
                <div class="footer-info d-flex justify-content-between mt-3">
                    <span>
                        Account created:
                        {{ $employee->created_at ? $employee->created_at->format('M Y') : 'N/A' }}
                    </span>
